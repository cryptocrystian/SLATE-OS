...
**Sprint 4C-D — PDF candidate polish + acceptance test backlog closure** per `docs/21` § Recommended Next Sprint. Sprint 4C-C audit (above) accepted Sprint 4C-B with notes; the deferred items it surfaced are operator-driven acceptance checks that need a stable dev server to complete:
